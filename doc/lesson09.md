...
> - В js строку "встроили переменные" с помощью обратного слеша (backtick, "`")([String Interpolation in JavaScript](https://www.geeksforgeeks.org/javascript/string-interpolation-in-javascript/)).
...
См. <a href="https://web.archive.org/web/20250216223940/https://javatutor.net/books/tiej/servlets#_Toc39472970">обработка сессий с помощью сервлетов</a>
