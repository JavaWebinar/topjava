...
--------------
### Установка через Docker (если у вас старый Windows или Windows 10 Home, выделите каое-то разумное время на этот вариант - с ним можно долго провозиться. Возможно сначала лучше сделать ДЗ)
