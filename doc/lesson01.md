...
- **ОСНОВНОЕ, чему мы учимся на проекте: мыслить и работать как Java разработчики уже сейчас**, потом это будет гораздо сложнее и стоить дороже. Вот на мой взгляд [хорошие советы новичкам](https://blog.csssr.com/ru/article/how-to-be-a-beginner-developer). От себя я добавлю:
  ...
  - Учись исследовать проблему. Внимательное чтение логов и [умение дебажить](https://javarush.com/quests/lectures/questsyntaxpro.level20.lecture04) - основные навыки разработчика. Обычно самый верх самого нижнего эксепшена- причина ошибки, туда нужно ставить брекпойнт.
...
```
  ...
  - [Создание сервлетов для чайников. Пошаговое руководство](https://habr.com/ru/articles/333626/)
  - <a href="https://java-course.ru/old/students/part8.html">JSP</a>
  - <a href="https://study-and-dev.com/blog/jstl_1/">JSTL: Шаблоны для разработки веб-приложений в java</a>
  - [Основные возможности JSTL](https://metanit.com/java/javaee/3.12.php)
